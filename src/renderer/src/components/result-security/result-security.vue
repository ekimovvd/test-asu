<template>
  <div class="result-security">
    ...
    <p class="result-security__label">
      По результатам проведенного аудита на соответствие требованиям информационной безопасности для АСУ согласно приказу ФСТЭК от 14 марта 2014 г. №31 ваша АСУ {{ displayedCorrect }} классу защищенности.
    </p>
  ...
  methods: {
    handleDocument() {
      downloadTest2({
        ...
        result: `В ходе проведения аудита автоматизированной системы управления "${this.asuName}" ей был присвоен класс защищенности ${CLASS_NAME[this.displayedClass]}, и его результатом является следующий вывод: ${this.displayedCorrect} классу защищенности согласно требованиям указанным в приказе ФСТЭК от 14 марта 2014 г. №31`
      })
    },
